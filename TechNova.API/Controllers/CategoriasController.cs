...
namespace TechNova.API.Controllers
{
    ...
    public class CategoriasController : ControllerBase
    {
        ...
        public CategoriasController(TechNovaContext context)
        {
            _context = context;
        }
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutCategorias(int id, Categoria categorias)
        {
            if (id != categorias.Id)
            {
                return BadRequest();
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<Categoria>> PostCategorias(Categoria categorias)
        {
